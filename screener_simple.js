...
// ── Config ────────────────────────────────────────────────────────────────────
const WATCHLIST = ['AADI','AHAP','ARCI','ASPR','BBRI','BBYB','BIPI','BMRI','BNBR','BRMS',
'BRPT','BULL','BUMI','BUVA','BWPT','CARE','CASH','COCO','CTTH','CUAN',
'DATA','DEWA','DKFT','ELSA','EMAS','ESIP','ESSA','FORE','GOTO','GTSI',
'HUMI','ICON','IMPC','INDY','KETR','KING','KPIG','MAIN','MBMA','MBSS',
'MDKA','MINA','NAYZ','NINE','PADA','PADI','PANI','PPRE','PSKT','PTPP',
'PYFA','RAJA','SOFA','SUPA','TAPG','TKIM','TPIA','TRIN','TRUE','VKTR',
'WIFI','WMUU','YELO','ZATA'
];
